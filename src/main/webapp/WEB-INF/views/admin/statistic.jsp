...
<%--                        <h2>${sessionScope.admin.getTenKh()}</h2>--%>
                    </div>
                </div>
                <!-- /menu profile quick info -->
                            ...
                            Film festivals used to be do-or-die moments for movie makers. They were where/assetsadmin.
                                ...
                                <li class="nav-item">
                                    <a class="dropdown-item">
                                        <span class="image"><img src="images/img.jpg" alt="Profile Image" /></span>
                                        <span>
<%--                            <span>${sessionScope.admin.getTenKh()}</span>--%>
                            <span class="time">3 mins ago</span>
                          </span>
                                        <span class="message">
                            Film festivals used to be do-or-die moments for movie makers. They were where/assetsadmin.
                        ...
                        <div class="col-md-5 col-sm-5   form-group pull-right top_search">
                            <form action="/admin?page=1" method="get">
                                <div class="input-group">
                                    <input type="text" class="form-control" name="key" value="" placeholder="Search for/assetsadmin.">
                                    ...
                                    <div class="col-md-12" style="height: 100%;">
                                        <div class="form-group col-md-12">
                                            <div class="col-md-6">
                                                ...
                                                <canvas id="myChartPost"></canvas>
                                                <canvas id="myChartSocailTraffic"></canvas>
                                            </div>
                                        </div>
...
<script type="text/javascript">
    let myChart = document.getElementById('myChartPost').getContext('2d');
    let myChart2 = document.getElementById('myChartSocailTraffic').getContext('2d');
    // Global Options
    ...
    let massPopChart = new Chart(myChart, {
        ...
        data:{
            ...
            datasets:[{
                label:'Số lượng bài post mỗi tháng',
                data:[
                    ${dataPost}
                ],
    ...
    let massPopChart2 = new Chart(myChart2, {
        ...
        options:{
            title:{
                display:true,
                text:'Thống kê lượt Khách hàng đặt mua theo tháng',
                fontSize:25
            },
            legend:{
                display:true,
