                ...
                <div class="w-100 justify-content-md-center">
                    <ul class="nav navbar-nav enable-mobile px-2">
                        ...
                        <li class="nav-item w-100 py-2">
                            <form method="get" action="/searchuser" class="d-inline form-inline w-100 px-4">
                                ...
                                <div class="row px-2">
                                    <div class="col-md-9 profile-center">
                                        ...
                                        <ul class="list-group list-group-horizontal types-list fs-8">
                                            ...
                                            <form id="searchFollowingForm" class="list-group-item d-flex w-100 align-items-center p-0 form-inline dropdown search-form">
                                                <div class="input-group w-95" data-toggle="dropdown"
                                                    ...
                                                    <input type="text" id="key" class="form-control search-input"
                                                           ...
                                                           aria-label="Search" aria-describedby="search-addon">
                                                    <div class="input-group-append">
                                                        <button class="btn search-button" type="button" style="cursor: pointer" onclick="searchFollowing()"><i
                                        ...
                                        <div class="bg-white py-3 px-4 shadow-sm">
                                            ...
                                            <div class="row" id="lifollowing">
                                                <c:forEach var="item" items="${listFollowing}">
                                                    <a style="width: 100%;" href="/profile/${item.id}">
                                                    <div class="col-md-12 col-sm-12">
                                                        <div class="follow-card">
                                                            <div class="menu-user-image follow-avatar">
                                                                <img src="${item.linkImgAvatar}" style="height: 50px; width: auto;" class="menu-user-img ml-1"
                                                                     alt="Menu Image">
                                                            </div>
                                                            <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4" style="text-align: center;">
                                                    <p onclick="loadFollowing()" style="cursor: pointer;color: #95999c">More</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<script>
    ...
    function loadFollowing() {
        $.ajax({
            type : "get",
            url : "/api/followings?page="+i,
            success : function(response) {
                var lifollowing = document.getElementById("lifollowing");
    ...
    function searchFollowing() {
        ...
        $.ajax({
            type : "get",
            url : "/api/searchfollowing?key="+key,
            success : function(response) {
                $.each(response, function (index, item) {
