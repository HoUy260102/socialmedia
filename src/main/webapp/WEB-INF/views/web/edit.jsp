                ...
                <div class="row">
                  <div class="col-md-12 profile-center">
                    ...
                    <div class="bg-white profile-posts-options mt-5 mb-4 py-3 d-flex justify-content-between shadow-sm">
                      <div class="col-sm-12">
                        <div class="col-md-12">
                          <form:form action="/edit-profileapply" method="POST" modelAttribute="userEdit" class="pt-5" enctype="multipart/form-data">
                            <div class="row col-md-12">
                              ...
                              <div class="col-md-12">
                                <div class="form-group">
                                  <form:input type="text" class="form-control" path="work" placeholder="Work"/>
                                </div>
                              </div>
                              <div class="col-md-12">
                                <div class="form-group">
                                  <form:input type="text" class="form-control" path="live" placeholder="Live in"/>
                                </div>
                              </div>
                              <div class="col-md-12">
                                <div class="form-group">
                              ...
                              <div class="col-md-6 text-right">
                                <div class="form-group">
                                  <button type="submit" class="btn btn-primary sign-up">Edit</button>
                                </div>
                              </div>
                            </div>
                          </form:form>
