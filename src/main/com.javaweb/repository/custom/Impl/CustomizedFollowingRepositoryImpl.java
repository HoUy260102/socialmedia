...
public class CustomizedFollowingRepositoryImpl implements CustomizedFollowingRepository {
    ...
    public List<UserEntity> getFollowingPage(Long userId, Long page) {
        String sql = "select u.id, u.email,u.password, u.firstname, u.lastname, u.dateofbirth, u.linkimgavatar, u.work, u.live, u.phonenumber, u.active, u.role, u.enable from following f\n" +
